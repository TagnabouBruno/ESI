...
<header class="header-fixed">
    ...
    <h1><a href="">Gestion<span> Scolaire</span>/ Carte<span> Etudiant</span></a></h1>
		...
		<nav>
			<div class="btn-group">
				<button type="button" class="btn btn-secondary"><a href="{{route('listesecretaire2')}}">Mon compte</a></button>
			</div>
			<div class="btn-group">
  				...
  				<ul class="dropdown-menu dropdown-menu-end">
    				...
    				<a href="{{route('liste_etudiant2')}}"><li><button class="dropdown-item" type="button">Listes</button></li></a>
  				</ul>
			</div>
        	<div class="btn-group">
