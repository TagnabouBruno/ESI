...
<header class="header-fixed">
    ...
    <h1><a href="">Gestion<span> Scolaire</span>/ Carte<span> Etudiant</span></a></h1>
		...
		<nav>
			<div class="btn-group">
				<a href="{{route('listeadmin')}}"><button type="button" class="btn btn-secondary">Mon compte</button></a>
			</div>
			<div class="btn-group">
        	...
        	<div class="btn-group">
            	<button type="button" class="btn btn-secondary"><a href="{{route('connectionadmi')}}">Déconnexion</a></button>
			</div>
		</nav>
...
<div class="btn-group">
  ...
  <form method="post" action="{{route('filiere')}}">
	...
	@method('post')
		<label>filiere:</cycle>
		<input name="libelle_filiere" placeholder="filiere" type="text">
...
<div class="btn-group">
  ...
  <ul class="dropdown-menu dropdown-menu-end">
    <form method="post" action="{{route('cycle')}}">
	@csrf
	@method('post')
		<label>cycle:</cycle>
		<input name="libelle_cycle" placeholder="cycle" type="text">
		<button  type="submit" class="btn btn-primary">enregistrer<button>
	</form>
  </ul>
</div>
<div class="btn-group">
  ...
  <form method="post" action="{{route('niveau')}}">
	...
	@method('post')
		<label>niveau:</cycle>
		<input name="libelle_niveau" placeholder="niveau" type="text">
		<button  type="submit" class="btn btn-primary">enregistrer<button>
	</form>
  </ul>
</div>
<div class="btn-group">
  ...
  <ul class="dropdown-menu dropdown-menu-end">
  <form method="post" action="{{route('semestre')}}">
  	@method('post')
	@csrf
		<label>semestre:</cycle>
		<input name="libelle_semestre" placeholder="semestre" type="text">
		<button  type="submit" class="btn btn-primary">enregistrer<button>
	</form>
  </ul>
</div></section>
